...
SHORTLINK_API = environ.get('SHORTLINK_API', 'e306dac19d0a3b53e1e058cd51c2c5eb0aff06fc')
...
URL = "https://agl-bot.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://agl-bot.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://agl-bot.onrender.com/".format(FQDN)
else:
    URL = "https://agl-bot.onrender.com/".format(FQDN)
